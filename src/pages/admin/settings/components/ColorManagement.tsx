...
export const ColorManagement = () => {
      ...
      colors: [
        {
          id: "10",
          name: "Ocean",
          value: "linear-gradient(135deg, #1B2B5B 0%, #40E0D0 100%)",
          description: "Ocean gradient",
        },
        {
          id: "11",
          name: "Sunset",
          value: "linear-gradient(135deg, #6B4C9A 0%, #C5A572 100%)",
  ...
  const totalColors = colorGroups.reduce(
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage your brand's color palette ({totalColors}/30 colors used)
          </p>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div
                      ...
                      style={{
                        ...
                        backgroundImage: color.value.includes("gradient")
                          ? color.value
                          : "none",
                      }}
                    />
