        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <Toggle
                  ...
                  onChange={(checked) =>
                    setSettings((prev) => ({ ...prev, afterHours: checked }))
                  }
                />
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <Toggle
                  ...
                  onChange={(checked) =>
                    setSettings((prev) => ({ ...prev, lunchHours: checked }))
                  }
                />
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <Toggle
                  ...
                  onChange={(checked) =>
                    setSettings((prev) => ({ ...prev, holidays: checked }))
                  }
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Toggle
                ...
                onChange={(checked) =>
                  setSettings((prev) => ({ ...prev, customSchedule: checked }))
                }
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-gray-500">
                Your request will be sent to Ngenius support for review and
                implementation.
              </p>
            </div>
          </div>
